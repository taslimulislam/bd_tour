...
public class ctg17Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg17);

        getSupportActionBar().setTitle("নাফাখুম জলপ্রপাত");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/Y9FO-1tA-b4?rel=0\"" +
