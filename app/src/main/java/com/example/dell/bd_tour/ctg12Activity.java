...
public class ctg12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg12);

        getSupportActionBar().setTitle("ওয়ার সিমেট্রি");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/G01_o9LavUI?rel=0\"" +
