...
public class sly1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly1);

        getSupportActionBar().setTitle("হযরত শাহজালাল (রঃ) ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/-2nIuYYAsgw?rel=0\"\n" +
