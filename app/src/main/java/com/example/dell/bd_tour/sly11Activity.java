...
public class sly11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly11);

        getSupportActionBar().setTitle("হযরত শাহ পরাণ (রাঃ) ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/Z_e_BqFrvXQ?rel=0\" \n" +
