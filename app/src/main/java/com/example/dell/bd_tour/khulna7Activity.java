...
public class khulna7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khulna8);

        getSupportActionBar().setTitle("দুবলার চর");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/UWlf5gvRbkU?rel=0\"\n" +
