...
public class sly12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly12);

        getSupportActionBar().setTitle("ডিবির হাওর");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/nVeGh9QjtXk?rel=0\"\n" +
