...
public class sly4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly4);

        getSupportActionBar().setTitle("বিছনাকান্দি");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/r1AjWAJLGLY?rel=0\" \n" +
