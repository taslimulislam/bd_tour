...
public class bari6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bari6);

        getSupportActionBar().setTitle("মিয়াবাড়ি মসজিদ");

        video_view = (WebView) findViewById(R.id.Videoview);
        String video_link = "<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/IIDWHedoKm0?rel=0\" \n" +
