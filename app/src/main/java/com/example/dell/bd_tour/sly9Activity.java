...
public class sly9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly9);

        getSupportActionBar().setTitle("সংগ্রামপুঞ্জি");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/T6wZSxZCdiM?rel=0\" \n" +
