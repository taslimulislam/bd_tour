...
public class raj4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raj4);

        getSupportActionBar().setTitle("বাঘা মসজিদ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/pPipv-dEVjA?rel=0\" \n" +
