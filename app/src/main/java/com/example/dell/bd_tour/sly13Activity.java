...
public class sly13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly13);

        getSupportActionBar().setTitle("হাম হাম ঝর্ণা");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/sDOw8khl-hg?rel=0\" \n" +
