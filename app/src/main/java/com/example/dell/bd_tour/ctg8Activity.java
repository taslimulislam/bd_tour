...
public class ctg8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg8);

        getSupportActionBar().setTitle("সীতাকুণ্ড ইকো পার্ক");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/5v58HkuqjTQ?rel=0\"" +
