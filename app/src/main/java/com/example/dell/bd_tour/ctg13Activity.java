...
public class ctg13Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg13);

        getSupportActionBar().setTitle("পারকি সমুদ্র সৈকত");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/XtMKMgakCeg?rel=0\" " +
