...
public class bari4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bari4);

        getSupportActionBar().setTitle("গুঠিয়া মসজিদ");

        video_view = (WebView) findViewById(R.id.Videoview);
        String video_link = "<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/N74bV5ccf20?rel=0\" \n" +
