...
public class ctg20Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg20);

        getSupportActionBar().setTitle("নিঝুম দ্বীপ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/YuriBLaoRL0?rel=0\" " +
