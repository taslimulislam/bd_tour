...
public class ctg5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg5);

        getSupportActionBar().setTitle("কমলদহ ঝর্ণা ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/3Aqj0gwN3Oo?rel=0\" " +
