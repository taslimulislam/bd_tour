...
public class sly3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sly3);

        getSupportActionBar().setTitle("পান্থুমাই ঝর্ণা");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/XcpEJ8bIxQ0?rel=0\"\n" +
