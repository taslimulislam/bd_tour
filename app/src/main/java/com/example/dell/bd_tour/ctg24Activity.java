...
public class ctg24Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg24);

        getSupportActionBar().setTitle("চন্দ্রনাথ পাহাড়");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/RsiJW23p9L8?rel=0\" " +
