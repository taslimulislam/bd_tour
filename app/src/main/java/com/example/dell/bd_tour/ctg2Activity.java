...
public class ctg2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg2);

        getSupportActionBar().setTitle("রামু বৌদ্ধ বিহার");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/ylj4jzURnLY?rel=0\"" +
