...
public class ctg11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctg11);

        getSupportActionBar().setTitle("মিনি বাংলাদেশ");

        video_view = (WebView)findViewById(R.id.Videoview);
        String video_link="<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/8W123asNTCg?rel=0\" " +
