...
public class bari2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bari2);

        getSupportActionBar().setTitle("শাপলা গ্রাম");

        video_view = (WebView) findViewById(R.id.Videoview);
        String video_link = "<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/wxK2__iGFxg?rel=0\"\n" +
