...
public class bari5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bari5);

        getSupportActionBar().setTitle("মনপুরা দ্বীপ");

        video_view = (WebView) findViewById(R.id.Videoview);
        String video_link = "<iframe width=\"380\" height=\"240\" src=\"https://www.youtube.com/embed/sUPju4eV9G4?rel=0\"\n" +
